...
const ThreadEntrySchema = new mongoose.Schema({
  kind: { type: String, enum: ['note', 'call', 'generated_note', 'decision', 'risk', 'action', 'status', 'meeting', 'follow_up', 'discussion', 'moms', 'progress'], required: true, index: true },
  sourceType: { type: String, enum: ['Teams meeting','Manual note','Call note','AI-generated note','Decision','Risk','Action','Manual meeting','Follow-up','Discussion','MoMs','Progress'], default: 'Manual note', index: true },
