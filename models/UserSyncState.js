...
const UserSyncStateSchema = new mongoose.Schema(
  {
    ...
    // v16.1: AI transcript ingestion status surfaced in the shell/sidebar
    lastSyncStartedAt: { type: Date, default: null },
    lastTranscriptAiLoadAt: { type: Date, default: null },
    lastSyncStatus: { type: String, default: 'idle', enum: ['idle', 'running', 'done', 'error'] },
    lastSyncError: { type: String, default: '' },
    lastSyncStats: { type: Object, default: {} },
