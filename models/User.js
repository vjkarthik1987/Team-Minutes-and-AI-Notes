...
const UserSchema = new mongoose.Schema(
  {
    ...
    preferences: {
      summaryStyle: { type: String, enum: ['balanced', 'executive', 'detailed'], default: 'balanced' },
      includeDetailedNotesByDefault: { type: Boolean, default: true },
      includeActionItemsByDefault: { type: Boolean, default: true },
      aiTone: { type: String, enum: ['practical', 'brief', 'warm', 'direct'], default: 'practical' },
    },
